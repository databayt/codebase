---
title: Introduction
description: A set of beautifully-designed, accessible components built with React and Tailwind CSS. Copy, paste, and customize to build your applications faster.
...
_In a typical library, if you need to change a button's behavior, you have to override styles or wrap the component. With our atoms, you simply edit the component code directly._

## Composition

Every component in our atoms collection shares a common, composable interface. **If a component does not exist, we bring it in, make it composable, and adjust its style to match and work with the rest of the design system.**
...
Start building with atoms today!
