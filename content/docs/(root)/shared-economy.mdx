...
<div className="grid grid-cols-1 md:grid-cols-3 gap-4 my-6">
  <div className="p-4 border rounded-lg">
    ...
    <p className="text-sm text-muted-foreground">Community input and transparent decision-making</p>
  </div>
  <div className="p-4 border rounded-lg">
    <h4 className="font-semibold mb-2">Contribution Tracker</h4>
    <p className="text-sm text-muted-foreground">GitHub Actions + SQLite for measurement</p>
  </div>
  <div className="p-4 border rounded-lg">
    <h4 className="font-semibold mb-2">Documentation</h4>
    <p className="text-sm text-muted-foreground">Public docs of all decisions and formulas</p>
  </div>
</div>
