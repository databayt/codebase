...
| Path                              | Description                                      |
| --------------------------------- | ------------------------------------------------ |
| `app/[lang]/(marketing)`          | Public marketing pages.                          |
| `app/[lang]/(operator)`           | Operator dashboard and management.               |
| `app/[lang]/(auth)`               | Authentication pages (login, register, etc.).    |
| `app/[lang]/onboarding`           | User onboarding flow.                            |
| `app/[lang]/s/[subdomain]`        | Multi-tenant subdomain routing.                  |
| `app/[lang]/s/[subdomain]/(platform)` | Tenant platform pages.                       |
| `app/[lang]/s/[subdomain]/(site)` | Tenant public site pages.                        |
| `components/atom`                 | Atomic design components (primitives).           |
| `components/marketing`            | Marketing page components.                       |
| `components/auth`                 | Authentication components.                       |
| `components/onboarding`           | Onboarding flow components.                      |
| `components/operator`             | Operator dashboard components.                   |
| `components/platform`             | Platform feature components.                     |
