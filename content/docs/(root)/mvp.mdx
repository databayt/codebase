...
**Implementation checklist for building a production-ready school management system**
...
<div className="grid grid-cols-1 md:grid-cols-3 gap-6 my-8">
  <div className="p-6 border rounded-lg text-center">
    ...
    <p className="text-sm text-muted-foreground">Core Epics</p>
  </div>
  ...
  <div className="p-6 border rounded-lg text-center">
    <h4 className="text-2xl font-bold text-green-600">~12 weeks</h4>
