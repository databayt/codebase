...
SaaS B2B multi-tenant school management system. Next.js 16 + React 19 + TypeScript + Prisma + PostgreSQL. 200+ functional requirements across 12 epics. FERPA/GDPR compliant. Arabic-first with RTL support.
