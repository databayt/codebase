...
SaaS B2B multi-tenant school management system. Next.js 16 + React 19 + TypeScript + Prisma + PostgreSQL. 9 core epics. FERPA/GDPR compliant. Arabic-first with RTL support.
...
- Multi-tenant (subdomain-based): `school.databayt.org` → `/[lang]/s/school/...`
