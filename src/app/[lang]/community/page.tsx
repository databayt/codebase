...
const Community = () => {
  return (
    <div className=''>
      ...
      <div className='flex flex-col w-full max-w-2xl mx-auto px-4 sm:px-6'>
      ...
      <div className='grid grid-cols-2 sm:grid-cols-4 gap-6 sm:gap-14 pt-10 w-full'>
        <Link href='/community/club' className='flex justify-center'>
        ...
        <Link href='/community/tool' className='flex justify-center'>
          <div className='flex flex-col items-center justify-center gap-1 reveal-less'>
            <div className='h-[65px] flex items-center justify-center'>
        ...
        <Link href='/community/project' className='flex justify-center'>
          <div className='flex flex-col items-center justify-center gap-1 reveal-less'>
            <div className='h-[65px] flex items-center justify-center'>
        ...
        <Link href='/community/add' className='flex justify-center'>
          <div className='flex flex-col items-center justify-center gap-1 reveal-less'>
            <div className='h-[65px] flex items-center justify-center'>
