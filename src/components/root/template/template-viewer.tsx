...
function useTemplateViewer() {
    ...
    if (!context) {
        throw new Error("useTemplateViewer must be used within a TemplateViewerProvider.")
    }
    return context
}
        ...
        <div className="group-data-[view=code]/template-view-wrapper:hidden flex md:h-[--height]">
            <div className="relative grid w-full gap-4">
                ...
                <ResizablePanelGroup direction="horizontal" className="relative z-10 after:absolute after:inset-0 after:end-3 after:z-0 after:rounded-xl after:bg-surface/50">
                    ...
                    <ResizableHandle className="relative hidden w-3 bg-transparent p-0 md:block cursor-col-resize after:absolute after:right-0 after:top-1/2 after:h-8 after:w-[2px] after:-translate-y-1/2 after:translate-x-[-1px] after:rounded-full after:bg-border after:transition-all after:hover:h-10 after:hover:bg-muted-foreground" />
